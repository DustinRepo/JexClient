...
public class CommandVClip extends Command {
    ...
    public int run(CommandContext<FabricClientCommandSource> context) throws CommandSyntaxException {
        ...
        NetworkHelper.INSTANCE.sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(Wrapper.INSTANCE.getLocalPlayer().getX(), Wrapper.INSTANCE.getLocalPlayer().getY() + up, Wrapper.INSTANCE.getLocalPlayer().getZ(), true));
