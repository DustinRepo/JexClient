...
BoatPaddleStateC2SPacket packet2 = (BoatPaddleStateC2SPacket) event.cancel();
}

if(bookupdate.value()){
BookUpdateC2SPacket packet3 = (BookUpdateC2SPacket) event.cancel();
}

if(buttonclick.value()){
ButtonClickC2SPacket packet4 = (ButtonClickC2SPacket) event.cancel();
}

if(chatmessage.value()){
ChatMessageC2SPacket packet5 = (ChatMessageC2SPacket) event.cancel();
}

if(clickslot.value()){
ClickSlotC2SPacket packet6 = (ClickSlotC2SPacket) event.cancel();
}

if(clientcommand.value()){
ClientCommandC2SPacket packet7 = (ClientCommandC2SPacket) event.cancel();
}

if(clientcettings.value()){
ClientSettingsC2SPacket packet8 = (ClientSettingsC2SPacket) event.cancel();
}

if(clientstatus.value()){
ClientStatusC2SPacket packet9 = (ClientStatusC2SPacket) event.cancel();
}

if(closehandledscreen.value()){
CloseHandledScreenC2SPacket packet10 = (CloseHandledScreenC2SPacket) event.cancel();
}

if(craftrequest.value()){
CraftRequestC2SPacket packet11 = (CraftRequestC2SPacket) event.cancel();
}

if(creativeinventoryaction.value()){
CreativeInventoryActionC2SPacket packet12 = (CreativeInventoryActionC2SPacket) event.cancel();
}

if(custompayload.value()){
CustomPayloadC2SPacket packet13 = (CustomPayloadC2SPacket) event.cancel();
}

if(handswing.value()){
HandSwingC2SPacket packet14 = (HandSwingC2SPacket) event.cancel();
}

if(jigsawgenerating.value()){
Jigsaws2ceneratingC2SPacket packet15 = (Jigsaws2ceneratingC2SPacket) event.cancel();
}

if(keepalive.value()){
KeepAliveC2SPacket packet16 = (KeepAliveC2SPacket) event.cancel();
}

if(pickfrominventory.value()){
PickFromInventoryC2SPacket packet17 = (PickFromInventoryC2SPacket) event.cancel();
}
if(playeraction.value()){
PlayerActionC2SPacket packet18 = (PlayerActionC2SPacket) event.cancel();
}
if(playerinput.value()){
PlayerInputC2SPacket packet19 = (PlayerInputC2SPacket) event.cancel();
}
if(playerinteractblock.value()){
PlayerInteractBlockC2SPacket packet20 = (PlayerInteractBlockC2SPacket) event.cancel();
}
if(playerinteractentity.value()){
PlayerInteractentityC2SPacket packet21 = (PlayerInteractentityC2SPacket) event.cancel();
}
if(playerinteractitem.value()){
PlayerInteractItemC2SPacket packet22 = (PlayerInteractItemC2SPacket) event.cancel();
}
if(playermove.value()){
PlayerMoveC2SPacket packet23 = (PlayerMoveC2SPacket) event.cancel();
}
if(playpong.value()){
PlayPongC2SPacket packet24 = (PlayPongC2SPacket) event.cancel();
}
if(queryblocknbt.value()){
QueryBlockNbtC2SPacket packet25 = (QueryBlockNbtC2SPacket) event.cancel();
}
if(queryentitynbt.value()){
QueryentityNbtC2SPacket packet26 = (QueryentityNbtC2SPacket) event.cancel();
}
if(recipebookdata.value()){
RecipeBookDataC2SPacket packet27 = (RecipeBookDataC2SPacket) event.cancel();
}
if(recipecategoryoptions.value()){
RecipeCategoryOptionsC2SPacket packet28 = (RecipeCategoryOptionsC2SPacket) event.cancel();
}
if(renameitem.value()){
RenameItemC2SPacket packet29 = (RenameItemC2SPacket) event.cancel();
}
if(requestcommandcompletions.value()){
RequestCommandCompletionsC2SPacket packet30 = (RequestCommandCompletionsC2SPacket) event.cancel();
}
if(resourcepackstatus.value()){
ResourcePackStatusC2SPacket packet31 = (ResourcePackStatusC2SPacket) event.cancel();
}
if(selectmerchanttrade.value()){
SelectMerchantTradeC2SPacket packet32 = (SelectMerchantTradeC2SPacket) event.cancel();
}
if(spectatorteleport.value()){
SpectatorTeleportC2SPacket packet33 = (SpectatorTeleportC2SPacket) event.cancel();
}
if(teleportconfirm.value()){
TeleportConfirmC2SPacket packet34 = (TeleportConfirmC2SPacket) event.cancel();
}
if(updatebeacon.value()){
UpdateBeaconC2SPacket packet35 = (UpdateBeaconC2SPacket) event.cancel();
}
if(updatecommandblockminecart.value()){
UpdateCommandBlockMinecartC2SPacket packet36 = (UpdateCommandBlockMinecartC2SPacket) event.cancel();
}
if(updatedifficulty.value()){
UpdateDifficultyC2SPacket packet37 = (UpdateDifficultyC2SPacket) event.cancel();
}
if(updatedifficultylock.value()){
UpdateDifficultyLockC2SPacket packet38 = (UpdateDifficultyLockC2SPacket) event.cancel();
}
if(updatejigsaw.value()){
UpdateJigsawC2SPacket packet39 = (UpdateJigsawC2SPacket) event.cancel();
}
if(updateplayerabilities.value()){
UpdatePlayerAbilitiesC2SPacket packet40 = (UpdatePlayerAbilitiesC2SPacket) event.cancel();
}
if(updateselectedslot.value()){
UpdateSelectedSlotC2SPacket packet41 = (UpdateSelectedSlotC2SPacket) event.cancel();
}
if(updatesign.value()){
UpdateSignC2SPacket packet42 = (UpdateSignC2SPacket)  event.cancel();
}
if(updatestructureblock.value()){
UpdateStructureBlockC2SPacket packet43 = (UpdateStructureBlockC2SPacket) event.cancel();
}
if(vehiclemove.value()){
VehicleMoveC2SPacket packet44 = (VehicleMoveC2SPacket)  event.cancel();
}

//--- s2c

if(advancementupdates2c.value()){
AdvancementUpdateS2CPacket packet45 = (AdvancementUpdateS2CPacket)  event.cancel();
}
if(blockbreakingprogresss2c.value()){
BlockBreakingProgressS2CPacket packet46 = (BlockBreakingProgressS2CPacket) event.cancel();
}
if(blockentityupdates2c.value()){
BlockEntityUpdateS2CPacket packet47 = (BlockEntityUpdateS2CPacket) event.cancel();
}
if(blockevents2c.value()){
BlockEventS2CPacket packet48 = (BlockEventS2CPacket) event.cancel();
}
if(blockupdates2c.value()){
BlockUpdateS2CPacket packet49 = (BlockUpdateS2CPacket) event.cancel();
}
if(bossbars2c.value()){
BossBarS2CPacket packet50 = (BossBarS2CPacket) event.cancel();
}
if(chunkdatas2c.value()){
ChunkDataS2CPacket packet51 = (ChunkDataS2CPacket) event.cancel();
}
if(chunkdeltaupdates2c.value()){
ChunkDeltaUpdateS2CPacket packet52 = (ChunkDeltaUpdateS2CPacket) event.cancel();
}
if(chunkloaddistances2c.value()){
ChunkLoadDistanceS2CPacket packet53 = (ChunkLoadDistanceS2CPacket) event.cancel();
}
if(chunkrenderdistancecenters2c.value()){
ChunkRenderDistanceCenterS2CPacket packet54 = (ChunkRenderDistanceCenterS2CPacket) event.cancel();
}
if(cleartitles2c.value()){
ClearTitleS2CPacket packet55 = (ClearTitleS2CPacket) event.cancel();
}
if(closescreens2c.value()){
CloseScreenS2CPacket packet56 = (CloseScreenS2CPacket) event.cancel();
}
if(commandsuggestionss2c.value()){
CommandSuggestionsS2CPacket packet57 = (CommandSuggestionsS2CPacket) event.cancel();
}
if(commandtrees2c.value()){
CommandTreeS2CPacket packet58 = (CommandTreeS2CPacket) event.cancel();
}
if(cooldownupdates2c.value()){
CooldownUpdateS2CPacket packet59 = (CooldownUpdateS2CPacket) event.cancel();
}
...
DifficultyS2CPacket packet63 = (DifficultyS2CPacket) event.cancel();
}
if(disconnects2c.value()){
DisconnectS2CPacket packet64 = (DisconnectS2CPacket) event.cancel();
}
if(endcombats2c.value()){
EndCombatS2CPacket packet65 = (EndCombatS2CPacket) event.cancel();
}
if(entercombats2c.value()){
EnterCombatS2CPacket packet66 = (EnterCombatS2CPacket) event.cancel();
}
if(entityanimations2c.value()){
EntityAnimationS2CPacket packet67 = (EntityAnimationS2CPacket) event.cancel();
}
if(entityattachs2c.value()){
EntityAttachS2CPacket packet68 = (EntityAttachS2CPacket) event.cancel();
}
if(entityattributess2c.value()){
EntityAttributesS2CPacket packet69 = (EntityAttributesS2CPacket) event.cancel();
}
if(entitydestroys2c.value()){
EntityDestroyS2CPacket packet70 = (EntityDestroyS2CPacket) event.cancel();
}
if(entityequipmentupdates2c.value()){
EntityEquipmentUpdateS2CPacket packet71 = (EntityEquipmentUpdateS2CPacket) event.cancel();
}
if(entitypassengerssets2c.value()){
EntityPassengersSetS2CPacket packet72 = (EntityPassengersSetS2CPacket) event.cancel();
}
if(entitypositions2c.value()){
EntityPositionS2CPacket packet73 = (EntityPositionS2CPacket) event.cancel();
}
if(entitys2c.value()){
EntityS2CPacket packet74 = (EntityS2CPacket) event.cancel();
}
if(entitysetheadyaws2c.value()){
EntitySetHeadYawS2CPacket packet75 = (EntitySetHeadYawS2CPacket) event.cancel();
}
if(entityspawns2c.value()){
EntitySpawnS2CPacket packet76 = (EntitySpawnS2CPacket) event.cancel();
}
if(entitystatuseffects2c.value()){
EntityStatusEffectS2CPacket packet77 = (EntityStatusEffectS2CPacket) event.cancel();
}
if(entitystatuss2c.value()){
EntityStatusS2CPacket packet78 = (EntityStatusS2CPacket) event.cancel();
}
if(entitytrackerupdates2c.value()){
EntityTrackerUpdateS2CPacket packet79 = (EntityTrackerUpdateS2CPacket) event.cancel();
}
if(entityvelocityupdates2c.value()){
EntityVelocityUpdateS2CPacket packet80 = (EntityVelocityUpdateS2CPacket) event.cancel();
}
if(experiencebarupdates2c.value()){
ExperienceBarUpdateS2CPacket packet81 = (ExperienceBarUpdateS2CPacket) event.cancel();
}
if(experienceorbspawns2c.value()){
ExperienceOrbSpawnS2CPacket packet82 = (ExperienceOrbSpawnS2CPacket) event.cancel();
}
if(explosions2c.value()){
ExplosionS2CPacket packet83 = (ExplosionS2CPacket) event.cancel();
}
if(gamejoins2c.value()){
}
if(gamemessages2c.value()){
GameMessageS2CPacket packet85 = (GameMessageS2CPacket) event.cancel();
}
if(gamestatechanges2c.value()){
GameStateChangeS2CPacket packet86 = (GameStateChangeS2CPacket) event.cancel();
}
if(healthupdates2c.value()){
HealthUpdateS2CPacket packet87 = (HealthUpdateS2CPacket) event.cancel();
}
if(inventorys2c.value()){
InventoryS2CPacket packet88 = (InventoryS2CPacket) event.cancel();
}
if(itempickupanimations2c.value()){
ItemPickupAnimationS2CPacket packet89 = (ItemPickupAnimationS2CPacket) event.cancel();
}
if(keepalives2c.value()){
KeepAliveS2CPacket packet90 = (KeepAliveS2CPacket) event.cancel();
}
if(lightupdates2c.value()){
LightUpdateS2CPacket packet91 = (LightUpdateS2CPacket) event.cancel();
}
if(lookats2c.value()){
LookAtS2CPacket packet92 = (LookAtS2CPacket) event.cancel();
}
if(mapupdates2c.value()){
MapUpdateS2CPacket packet93 = (MapUpdateS2CPacket) event.cancel();
}
if(mobspawns2c.value()){
MobSpawnS2CPacket packet94 = (MobSpawnS2CPacket) event.cancel();
}
if(nbtqueryresponses2c.value()){
NbtQueryResponseS2CPacket packet95 = (NbtQueryResponseS2CPacket) event.cancel();
}
if(openhorsescreens2c.value()){
OpenHorseScreenS2CPacket packet96 = (OpenHorseScreenS2CPacket) event.cancel();
}
...
PaintingSpawnS2CPacket packet100 = (PaintingSpawnS2CPacket) event.cancel();
}
if(particles2c.value()){
ParticleS2CPacket packet101 = (ParticleS2CPacket) event.cancel();
}
if(playerabilitiess2c.value()){
PlayerAbilitiesS2CPacket packet102 = (PlayerAbilitiesS2CPacket) event.cancel();
}
if(playeractionresponses2c.value()){
PlayerActionResponseS2CPacket packet103 =(PlayerActionResponseS2CPacket) event.cancel();
}
if(playerlistheaders2c.value()){
PlayerListHeaderS2CPacket packet104 = (PlayerListHeaderS2CPacket) event.cancel();
}
if(playerlists2c.value()){
PlayerListS2CPacket packet105 = (PlayerListS2CPacket) event.cancel();
}
if(playerpositionlooks2c.value()){
PlayerPositionLookS2CPacket packet106 = (PlayerPositionLookS2CPacket) event.cancel();
}
if(playerrespawns2c.value()){
PlayerRespawnS2CPacket packet107 = (PlayerRespawnS2CPacket) event.cancel();
}
if(playerspawnpositions2c.value()){
PlayerSpawnPositionS2CPacket packet108 = (PlayerSpawnPositionS2CPacket) event.cancel();
}
if(playerspawns2c.value()){
PlayerSpawnS2CPacket packet109 = (PlayerSpawnS2CPacket) event.cancel();
}
if(playpings2c.value()){
PlayPingS2CPacket packet110 = (PlayPingS2CPacket) event.cancel();
}
if(playsoundfromentitys2c.value()) {
PlaySoundFromEntityS2CPacket packet111 = (PlaySoundFromEntityS2CPacket) event.cancel();
}
if(playsoundids2c.value()){
PlaySoundIdS2CPacket packet112 = (PlaySoundIdS2CPacket) event.cancel();
}
if(playsounds2c.value()){
PlaySoundS2CPacket packet113 = (PlaySoundS2CPacket) event.cancel();
}
if(removeentitystatuseffects2c.value()){
RemoveEntityStatusEffectS2CPacket packet114 = (RemoveEntityStatusEffectS2CPacket) event.cancel();
}
if(resourcepacksends2c.value()){
ResourcePackSendS2CPacket packet115 = (ResourcePackSendS2CPacket) event.cancel();
}
if(scoreboarddisplays2c.value()){
ScoreboardDisplayS2CPacket packet116 = (ScoreboardDisplayS2CPacket) event.cancel();
}
if(scoreboardobjectiveupdates2c.value()){
ScoreboardObjectiveUpdateS2CPacket packet117 = (ScoreboardObjectiveUpdateS2CPacket) event.cancel();
}
if(scoreboardplayerupdates2c.value()){
ScoreboardPlayerUpdateS2CPacket packet118 = (ScoreboardPlayerUpdateS2CPacket) event.cancel();
}
if(screenhandlerpropertyupdates2c.value()){
ScreenHandlerPropertyUpdateS2CPacket packet119 = (ScreenHandlerPropertyUpdateS2CPacket) event.cancel();
}
if(screenhandlerslotupdates2c.value()){
ScreenHandlerSlotUpdateS2CPacket packet120 = (ScreenHandlerSlotUpdateS2CPacket) event.cancel();
}
if(selectadvancementtabs2c.value()){
SelectAdvancementTabS2CPacket packet121 = (SelectAdvancementTabS2CPacket) event.cancel();
}
if(setcameraentitys2c.value()){
SetCameraEntityS2CPacket packet122 = (SetCameraEntityS2CPacket) event.cancel();
}
if(settradeofferss2c.value()){
SetTradeOffersS2CPacket packet123 = (SetTradeOffersS2CPacket) event.cancel();
}
if(signeditoropens2c.value()){
SignEditorOpenS2CPacket packet124 = (SignEditorOpenS2CPacket) event.cancel();
}
if(statisticss2c.value()){
StatisticsS2CPacket packet125 = (StatisticsS2CPacket) event.cancel();
}
if(stopsounds2c.value()){
StopSoundS2CPacket packet126 = (StopSoundS2CPacket) event.cancel();
}
if(subtitles2c.value()){
SubtitleS2CPacket packet127 = (SubtitleS2CPacket) event.cancel();
}
if(synchronizerecipess2c.value()){
SynchronizeRecipesS2CPacket packet128 =  (SynchronizeRecipesS2CPacket) event.cancel();
}
if(synchronizetagss2c.value()){
SynchronizeTagsS2CPacket packet129 = (SynchronizeTagsS2CPacket) event.cancel();
}
if(teams2c.value()){
TeamS2CPacket packet130 = (TeamS2CPacket) event.cancel();
}
if(titlefades2c.value()){
TitleFadeS2CPacket packet131 = (TitleFadeS2CPacket) event.cancel();
}
if(titles2c.value()){
TitleS2CPacket packet132 = (TitleS2CPacket) event.cancel();
}
if(unloadchunks2c.value()){
UnloadChunkS2CPacket packet133 = (UnloadChunkS2CPacket) event.cancel();
}
if(unlockrecipess2c.value()){
UnlockRecipesS2CPacket packet134 = (UnlockRecipesS2CPacket) event.cancel();
}
if(updateselectedslots2c.value()){
UpdateSelectedSlotS2CPacket packet135 = (UpdateSelectedSlotS2CPacket) event.cancel();
}
if(vehiclemoves2c.value()){
VehicleMoveS2CPacket packet136 = (VehicleMoveS2CPacket) event.cancel();
}
if(wibrations2c.value()){
VibrationS2CPacket packet137 = (VibrationS2CPacket) event.cancel();
}
if(worldbordercenterchangeds2c.value()){
WorldBorderCenterChangedS2CPacket packet138 = (WorldBorderCenterChangedS2CPacket) event.cancel();
}
if(worldborderinitializes2c.value()){
WorldBorderInitializeS2CPacket packet139 = (WorldBorderInitializeS2CPacket) event.cancel();
}
if(worldborderinterpolatesizes2c.value()){
WorldBorderInterpolateSizeS2CPacket packet140 = (WorldBorderInterpolateSizeS2CPacket) event.cancel();
}
if(worldbordersizechangeds2c.value()){
WorldBorderSizeChangedS2CPacket packet141 = (WorldBorderSizeChangedS2CPacket) event.cancel();
}
if(worldborderwarningblockschangeds2c.value()){
WorldBorderWarningBlocksChangedS2CPacket packet142 = (WorldBorderWarningBlocksChangedS2CPacket) event.cancel();
}
if(worldborderwarningtimechangeds2c.value()){
WorldBorderWarningTimeChangedS2CPacket packet143 = (WorldBorderWarningTimeChangedS2CPacket) event.cancel();
}
if(worldevents2c.value()){
WorldEventS2CPacket packet144 = (WorldEventS2CPacket) event.cancel();
}
