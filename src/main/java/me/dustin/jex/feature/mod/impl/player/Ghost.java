...
public class Ghost extends Feature {
    ...
    @EventListener(events = {EventSetPlayerHealth.class, EventSetScreen.class, EventJoinWorld.class}, priority = EventPriority.HIGH)
    private void runMethod(Event event) {
        ...
        else if (event instanceof EventSetScreen eventDisplayScreen) {
