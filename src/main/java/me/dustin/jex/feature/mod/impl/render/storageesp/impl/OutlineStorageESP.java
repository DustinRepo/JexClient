                ...
                WorldHelper.INSTANCE.getBlockEntities().forEach(blockEntity -> {
                    if (storageESP.isValid(blockEntity)) {
                        ...
                        if (blockEntityBlockEntityRenderer != null)
                            blockEntityBlockEntityRenderer.render(blockEntity, eventWorldRender.getPartialTicks(), eventWorldRender.getPoseStack(), outlineVertexConsumerProvider, 0xF000F0, OverlayTexture.DEFAULT_UV);
