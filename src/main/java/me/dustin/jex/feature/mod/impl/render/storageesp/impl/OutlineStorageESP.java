                ...
                WorldHelper.INSTANCE.getBlockEntities().forEach(blockEntity -> {
                    if (storageESP.isValid(blockEntity)) {
                        ...
                        if (blockEntityBlockEntityRenderer != null)
                            blockEntityBlockEntityRenderer.render(eventWorldRender.getPoseStack(), outlineVertexConsumerProvider, blockEntity, eventWorldRender.getPartialTicks(), 0xF000F0, OverlayTexture.DEFAULT_UV);
