...
@Feature.Manifest(name = "BedrockObfuscator", category = Feature.Category.WORLD, description = "Rearranges Bedrock at the bottom of the world and top of the Nether to avoid seed searching.")
