...
public class ArisIntOptionButton extends IntOptionButton {
    public ArisIntOptionButton(DropdownWindow window, IntOption option, float x, float y, float width, float height) {
