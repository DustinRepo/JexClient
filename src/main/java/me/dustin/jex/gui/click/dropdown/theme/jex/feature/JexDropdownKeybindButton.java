...
public class JexDropdownKeybindButton extends DropdownKeybindButton {
    public JexDropdownKeybindButton(DropdownWindow window, Feature feature, float x, float y, float width, float height) {
    ...
    public void render(PoseStack matrixStack) {
        ...
        FontHelper.INSTANCE.drawWithShadow(matrixStack, getName(), getX() + 2, getY() + 2, EventManager.isRegistered(this) ? getWindow().getColor() : -1);
    }
