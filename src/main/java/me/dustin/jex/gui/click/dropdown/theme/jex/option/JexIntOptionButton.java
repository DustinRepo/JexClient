...
public class JexIntOptionButton extends IntOptionButton {
    public JexIntOptionButton(DropdownWindow window, IntOption option, float x, float y, float width, float height) {
