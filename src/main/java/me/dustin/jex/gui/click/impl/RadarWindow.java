...
import me.dustin.jex.module.impl.world.Radar;
...
public class RadarWindow extends Window{
    ...
    public void draw(MatrixStack matrixStack) {
        ...
        matrixStack.multiply(new Quaternion(new Vector3f(0.0F, 0.0F, 1.0F), Wrapper.INSTANCE.getLocalPlayer().yaw + 180, true));
