...
public class JexGuiScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.searchBar = new TextFieldWidget(Wrapper.INSTANCE.getTextRenderer(), (int) (getX() + 2 + FontHelper.INSTANCE.getStringWidth("Search: ")), getY() + 28, (int) (getGuiWidth() - 4 - FontHelper.INSTANCE.getStringWidth("Search: ")), 25, Text.literal(""));
        ...
        this.addDrawableChild(new ButtonWidget(2, height - 88, 100, 20, Text.of("Edit Keybinds"), button -> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        FontHelper.INSTANCE.drawWithShadow(matrices, "Search: ", getX() + 2, getY() + 28, ColorHelper.INSTANCE.getClientColor());
    ...
    public void drawClientText(MatrixStack matrices) {
        ...
        FontHelper.INSTANCE.drawCenteredString(matrices, "Jex Client", (width / 2.f) / 2.f, (getY() + 5) / 2.f, ColorHelper.INSTANCE.getClientColor());
