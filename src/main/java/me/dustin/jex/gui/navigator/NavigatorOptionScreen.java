...
import me.dustin.jex.gui.navigator.impl.NavigatorFeatureVisibleButton;
import me.dustin.jex.gui.navigator.impl.NavigatorKeybindButton;
import me.dustin.jex.gui.navigator.impl.NavigatorOptionButton;
    ...
    protected void init() {
        ...
        for (Property property : PropertyManager.INSTANCE.get(feature.getClass())) {
            if (property.getParent() == null) {
                NavigatorOptionButton navigatorOptionButton = new NavigatorOptionButton(property, navigator.navigatorX, navigator.navigatorY + 92 + buttonHeight, navigator.navigatorWidth, 15);

                if (property.value() instanceof Color)
