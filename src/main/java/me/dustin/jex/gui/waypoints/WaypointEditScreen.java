...
public class WaypointEditScreen extends Screen {
    ...
    protected void init() {
        ...
        nametagButton = new Button(null, nametagButtonName, width / 2.f - 100, height / 2.f + 5, 65, 20, nametagListener);
        beaconButton = new Button(null, beaconButtonName, width / 2.f - 32.5f, height / 2.f + 5, 65, 20, beaconListener);
        tracerButton = new Button(null, tracerButtonName, width / 2.f + 35, height / 2.f + 5, 65, 20, tracerListener);
        hiddenButton = new Button(null, hiddenButtonName, width / 2.f - 100, height / 2.f + 30, 200, 20, hiddenListener);
        ...
        this.colorWidth = 110;
        saveButton = new Button(null, "Save", width / 2.f - 100, height / 2.f + 55, 80, 20, saveListener);
        cancelButton = new Button(null, "Cancel", width / 2.f - 100, height / 2.f + 80, 80, 20, cancelListener);
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        hiddenButton.draw(matrices);
        nametagButton.draw(matrices);
        beaconButton.draw(matrices);
        tracerButton.draw(matrices);
        saveButton.draw(matrices);
        cancelButton.draw(matrices);
