...
public enum PlayerHelper {
    ...
    public void block(boolean ignoreNewCombat) {
        if (ignoreNewCombat) {
            if (Wrapper.INSTANCE.getLocalPlayer().getMainHandStack() != null && Wrapper.INSTANCE.getLocalPlayer().getMainHandStack().getItem() instanceof SwordItem) {
                ...
                Wrapper.INSTANCE.getInteractionManager().interactItem(Wrapper.INSTANCE.getLocalPlayer(), Hand.OFF_HAND);
            }
        } else {
    ...
    public void placeBlockInPos(BlockPos blockPos, Hand hand, boolean illegallPlace) {
        ...
        if (placePos == null) {
            if (illegallPlace) {
                Wrapper.INSTANCE.getInteractionManager().interactBlock(Wrapper.INSTANCE.getLocalPlayer(), hand, new BlockHitResult(new Vec3d(blockPos.getX(), blockPos.getY(), blockPos.getZ()), Direction.UP, blockPos, false));
                swing(hand);
            }
        } else {
            ...
            Wrapper.INSTANCE.getInteractionManager().interactBlock(Wrapper.INSTANCE.getLocalPlayer(), hand, blockHitResult);
            swing(hand);
        }
    }
    ...
    public void useItem(Hand hand) {
        Wrapper.INSTANCE.getInteractionManager().interactItem(Wrapper.INSTANCE.getLocalPlayer(), hand);
    }
