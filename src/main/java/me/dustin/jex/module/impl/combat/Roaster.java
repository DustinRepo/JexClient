...
@ModClass(name = "Roaster", category = ModCategory.COMBAT, description = "Roast your friends.")
public class Roaster extends Module {
    ...
    private boolean isValid(LivingEntity livingEntity) {
        ...
        if (livingEntity instanceof PlayerEntity) {
            if (Friend.isFriend(livingEntity.getName().asString()))
                return friends;
            return player;
        }
