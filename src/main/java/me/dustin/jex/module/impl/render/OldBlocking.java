...
@ModClass(name = "OldBlocking", category = ModCategory.VISUAL, description = "Get the pre-1.9 block animation when blocking with a shield.")
public class OldBlocking extends Module {
