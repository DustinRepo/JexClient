...
import me.dustin.jex.module.impl.render.BlockOverlay;
...
@ModClass(name = "AirPlace", category = ModCategory.WORLD, description = "Gives you the ability to place blocks in the air. (Anticheats usually block this)")
